    ...
    <div className="sticky top-0 inset-x-0   flex  px-16 py-4 justify-between place-items-center text-lg  font-medium  ">
      <ul className="flex justify-items-center justify-evenly space-x-8 ">
        ...
        >
          ...
          } px-2 py-1 hover:bg-[#2E424D] hover:text-white duration-300 rounded-sm`} href="/">Home</Link>
        </li>
        <li
        >
          <Link   className={` px-2 py-1  duration-400 ${
            currentPath === "/products" && "border-b-2 border-black  "
          } px-2 py-1 hover:bg-[#2E424D] hover:text-white duration-300 rounded-sm`} href="/products">Products</Link>
        </li>
        <li
        >
          <Link className={`duration-400 ${
            currentPath === "/cart" && "border-b-2 border-black"
          } px-2 py-1 hover:bg-[#2E424D] hover:text-white duration-300 rounded-sm `} href="/cart">Cart</Link>
        </li>
      </ul>
